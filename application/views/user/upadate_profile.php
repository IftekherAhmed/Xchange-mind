        ...
        <div class="container my-2">
            <div class="row" style="margin-bottom: 200px;">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 bg-white form-shadow my-2">
                    <div class="m-4">						
                        <h3 class="text-secondary"><span class="fa fa-user-secret text-info"></span> Update Your Profile</h3>
                        <br />
                        
                        <?php echo form_open_multipart("ct_user/update_profile/{$user_id}"); ?> 
						<?php 
						...
						?>
							...
							<?php echo form_input(['name'=>'user_name', 'class'=>'form-control', 'type'=>'text', 'placeholder'=>'Name', 'value'=>$user_name]); ?>
                            </div>	

                            <div class="form-group">
                            <?php echo form_error('user_number', '<div class="text-danger">', '</div>');?>
							<?php echo form_label('Number');?>
							<?php echo form_input(['name'=>'user_number', 'class'=>'form-control', 'type'=>'text', 'placeholder'=>'Number', 'value'=>$user_number]); ?>
                            </div>	
                            
                            <div class="form-group">
                            <?php echo form_error('user_email', '<div class="text-danger">', '</div>');?>
							<?php echo form_label('Email');?>
							<?php echo form_input(['name'=>'user_email', 'class'=>'form-control', 'type'=>'text', 'placeholder'=>'Email', 'value'=>$user_email]); ?>
							...
							<?php echo form_label('Link');?>							
								<div class="input-group">
									...
									<?php echo form_input(['name'=>'user_link', 'class'=>'form-control', 'type'=>'text', 'placeholder'=>'Link', 'value'=>$user_link]); ?>
								</div>
                            </div>
							...
							<?php echo form_textarea(['name'=>'user_about', 'class'=>'form-control', 'rows'=>'4', 'cols'=>'30', 'placeholder'=>'About', 'value'=>$user_about]); ?>
                           </div>
                            
                            <div class="form-group">
                            <?php echo form_error('user_address', '<div class="text-danger">', '</div>');?>
							<?php echo form_label('Address');?>
							<?php echo form_textarea(['name'=>'user_address', 'class'=>'form-control', 'rows'=>'4', 'cols'=>'50', 'placeholder'=>'Address', 'value'=>$user_address]); ?>
                           </div>
