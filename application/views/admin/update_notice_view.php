...
<head>
    ...
    <title><?php echo $update_notice_view->notice_title;?> | <?php echo $site_title;?></title>
			...
			<div class="container">
				<div class="row p-3">
					...
					<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 my-1">
						...
						<?php
							if($update_notice_view):
						?>
							<?php echo form_open_multipart("ct_admin/single_notice_edit/{$update_notice_view->notice_id}", ['class'=>'']); ?> 
							<?php 
							...
							?>
								<div class="form-group">
									...
									<?php echo form_input(['name'=>'notice_title', 'class'=>'form-control mr-2', 'placeholder'=>'Notice Title', 'value'=>$update_notice_view->notice_title]); ?>									
								</div>	
								
								<div class="form-group">
									<?php echo form_error('notice_description', '<div class="text-danger">', '</div>');?>
									<?php echo form_label('Notice Description');?>
									<?php echo form_textarea(['name'=>'notice_description', 'class'=>'form-control', 'placeholder'=>'Notice', 'value'=>$update_notice_view->notice_description]); ?>
								</div>	
